	...
	public partial class QSTodoListViewController : UITableViewController
	{
		...
		async partial void OnAdd (UIButton sender)
		{
			...
			var newItem = new ToDoItem {
				Text = itemText.Text, 
                FaceBookName = "DummyData1", //this and all the below dummydata will be replaced
                TwitterHandle = "DummyData2",//with legitmate controls later on
                InstagramName = "DummyData3",
                MobilePhone = "DummyData4",
                EmailAddress = "DummyData5",
                Remove = false,
				Complete = false
			};
